<%-- 
    ...
    Created on : Oct 27, 2018, 12:02:50 PM
    Author     : timpinkerton
--%>
    ...
    <body>
        <div class="container">
            ...
            <div class="item-description-container">
                ...
                <h4 class="text-center">Here are the items in this category:</h4>

                <div class="row justify-content-center">
                    <div class="cat-item border">
                        <c:forEach items="${categoryId}" var="item">
                          ${item.categoryName}
                        </c:forEach>
                        <p>featured item info goes here...</p>
                        <p>Item name...</p>
